...
hexo.extend.tag.register('musicxml', function (args) {   
    ...
    if(loadPlayer === "true") {
        ...
        var css = util.htmlTag('link', {
            href: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.5/osmd-c.css',
            rel: 'stylesheet'
        });
        ...
        var pdfKit_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.5/pdfkit.js'
        },"",false);
    
        var blobStream_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.5/blobstream.js'
        },"",false);
        ...
        var mxl2midi_js = util.htmlTag('script', {
            src: "https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.5/gjs.js"
        },"",false);
    
        var osmd_app_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.5/osmd-app.min.js'
        }, "",false);
