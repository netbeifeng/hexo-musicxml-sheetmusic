...
hexo.extend.tag.register('musicxml', function (args) {
    ...
    if(loadPlayer === "true") {
        ...
        var css = util.htmlTag('link', {
            href: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.8/css/osmd-c.css',
            rel: 'stylesheet'
        });
        ...
        var pdfKit_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.8/libs/pdfkit.js'
        },"",false);

        var blobStream_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.8/libs/blobstream.js'
        },"",false);
        ...
        var mxl2midi_js = util.htmlTag('script', {
            src: "https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.8/libs/gjs.js"
        },"",false);

        var osmd_app_js = util.htmlTag('script',{
            src: 'https://cdn.jsdelivr.net/npm/hexo-musicxml-sheetmusic@0.0.8/libs/osmd-app.min.js'
        }, "",false);
